...
var dbfile = "/Users/cryptokitty/go/src/mumzic/gendb/media.db"
var processednum = 0
var errorednum = 0
var removednum = 0
...
func addPathToDB(metadata map[string]string, stmt *sql.Stmt) {
	//  /Users/cryptokitty/go/src/mumzic/music/SPEED GANG  H O E EXCLUSIVE LYRICS.mp3
	//  /Volumes/Transcend/music/__fullhouse/
	// _, err := stmt.Exec(metadata["artist"], metadata["album"], metadata["title"], metadata["path"])
	_, err := stmt.Exec(metadata["artist"], metadata["album"], metadata["path"][37:len(metadata["path"])-4], metadata["path"])
	if err != nil {
